...
function ImageTransition({ images, intervalTime = 3000, transitionTime = 500 }) {
  ...
  return (
    <img
      ...
      alt="Cruise Ship Transition"
      className={`w-full h-[600px] object-cover rounded shadow-lg transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}
    />
  );
}
